...
<body>
    <div class="full">
        <header>
            <h2><span><a href="/user/mainAfterMain" class="dreamer"><img src="/resources/images/Dreamer.png" width="210px" height="180px"></a></span></h2>
            <div class="navi">
        ...
        <div class="half">
            <div class="arrow_box">
                ...
                MY드리머</a></p>
                <p><a class="profile" href="/user/profileMain"style="text-decoration: none;">
                프로필</a></p>
