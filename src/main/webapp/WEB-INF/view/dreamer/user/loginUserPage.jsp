...
<body>
	<div class="full">
		...
		<header class="navbar">
			<div class="nav-con">
				<div style="width: 100%; display: inline;">
					<nav class="nv">
						<ul class="nv-st">
							<li><a id="nav3-1-logo" href="/user/mainAfterMain"><img
							...
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
							<li><a id="nav3-3-Resume" type="button"
								href="/user/resume?userEmail=${loginUser.userEmail}">이력서</a></li>
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
							<li><a id="nav3-4-Bookmark" type="button"
								href="/user/mydreamer">북마크</a></li>
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
							<li><a id="nav3-5-ApplicationStatus" type="button"
								href="/user/mydreamer">지원현황</a></li>
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
							<li><a id="nav3-1-blank" type="button">&nbsp;</a></li>
		...
		<div class="bar">
			<div class="opennavi"
				style="width: 100%; height: 286px; text-align: right; min-width: 1750px;">
				...
				<div
					...
					<ul>
						<li><input type="button" id="searchSearch" value="연출">
						</li>
						<li>감독</li>
						<li>조감독</li>
						<li>각본</li>
				...
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="조명">
						</li>
						<li>조명팀</li>
						<li>발전차</li>
					</ul>
				...
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="음향">
						</li>
						<li>음향팀</li>
						<li>동시녹음팀</li>
					</ul>
				...
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="촬영">
						</li>
						<li>촬영팀</li>
					</ul>
				</div>
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="특수효과">
						</li>
						<li>특수효과팀</li>
					</ul>
				</div>
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="제작">
						</li>
						<li>제작팀</li>
						<li>캐스팅담당팀</li>
					</ul>
				...
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="배우">
						</li>
						<li>주연</li>
						<li>조연</li>
						<li>스턴트</li>
				...
				<div
					style="width: 110px; height: 169px; margin-top: 20px; float: left; display: block; margin-inline-start: 30px;">
					<ul>
						<li><input type="button" id="searchSearch" value="미술">
						</li>
						<li>미술팀</li>
						<li>미술감독</li>
						<li>소품팀</li>
				...
				<div
					...
					<ul style="text-align: right;">
						<li><input type="button" id="searchSearch" value="분장">
						</li>
						<li>헤어팀</li>
						<li>의상팀</li>
						<li>분장팀</li>
		...
		<div class="half">
			<div style="float: left; display: block;">
					...
					<div class="sel">
						<table style="border-spacing: 5px 10px;">
								...
								<td>
									<form action="">
										<select id="job" class="job"
											onchange="doChange(this, 'detail_job')">
								...
								<td>
									<form action="">
										<select id="country" class="country"
											onchange="doChange(this, 'detail_country')">
							...
							<tr>
								...
								<td colspan="2"><span>&emsp;&emsp;&nbsp;
										<button type="button" id="select_reset_btn"
											class="select_reset_btn">초 기 화</button>
								</span></td>
							</tr>
						</table>
					</div>
				...
				<div class="company-job-list">
					<ul>
						<li class="company-job" style="text-align: center;"><c:forEach
								items="${comList}" var="comList">
								<div class="company-margin"
									data-pid=${comList.companyJobPostingId }>
									<ul>
										<li class="scrollH">
											<!-- 링크 --> <a class="company-href"
											href="/user/companypost?companyJobPostingId=${comList.companyJobPostingId }">
												<!-- 이미지 -->
												<div class="company-img"
													style="background-image: url(/resources/images/movie.jpg)"></div>
												<figcaption>
	...
	<script type="text/javascript" src="/resources/loginUserMain.js">
						...
						function() {
							...
							if (ScrollTop - lastScrollTop > 0) {
								...
								if ($(window).scrollTop() >= ($(document)
									...
									var lastpid = $(".company-margin:last")
											.attr("data-pid");
																...
																.each(
																		function() {
																			...
																			str += "<div class='company-margin' data-pid='"+this.companyJobPostingId+"'>"
																					+ "<ul>"
																					+ "<li class='scrollH'>"
																					+ " <a class='company-href' href='/user/companypost?companyJobPostingId="
																					+ this.companyJobPostingId
																					+ "'>"
																					+ "<div class='company-img' style='background-image:url(/resources/images/movie.jpg)'></div>"
																					+ "<figcaption>"
																					+ "<div id='job-card' style= 'font-size: 16px'>"
																					+ "<div class='job-card-position'>"
																					+ this.companyJobPostingTitle
																					+ "</div>"
																					+ "<br>"
									...
									var position = $(".company-margin:last")
											.offset(); //위치 값
