...
<body>
    ...
    <!-- 네비게이션바 END -->
        <div class="sec">
            <div class="mainFrame">
                <div class="text1" style="width: 500px; height: 100px; top: 15%; left: 50%; position: absolute;
                margin-top: -100px; margin-left: -250px; text-align: center; line-height: 40px;">
                    ...
                    <div style="height: 700px;">
                        <div style="width: 150px; height: 100px; top: 70%; left: 10%; position: absolute; margin-top: -50px; display: inline-block; z-index: 1;line-height: 40px;"><h1>드리머를 이용하는 이유</h1></div>
                        <div style="width: 500px; height: 130px; top: 40%; left: 50%; position: absolute;margin-top: -70px; margin-left: -250px; display: inline-block; z-index: 1; color: white;line-height: 40px;">
                            <h2>국내외 200만유저 및 10,000개 기업 이용<br>공고 후 채용 성공률 52%<br>채용 후 6개월 내 채용 유지율 95%<br>기존채널 대비 40% 이상 채용 비용 절감</h2></div>
                        <div style="width: 100%;"><img src="images/movie.jpg" style="width: 100%; height: 800px; top: 60%; position: absolute; margin-top: -300px;"> </div>   
                    </div>
                <div class="blank"></div>    
            ...
            <div class="ModalBody1">
                <div>
                    <label><input required id="findemail" type="email" placeholder="회사 이메일 (로그인계정)"autocomplete="off"></label>
                            <h5 style="display: inline-block; color: #a8a8a8; font-size: 15px;">비밀번호를 재설정할 이메일 계정을 입력해주세요</h5>
                </div>
                <footer class="foot">          
